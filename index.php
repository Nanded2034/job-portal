...
<body>
            ...
            <dvi>
                <div class="dropdown">
                    <a href="#"
                        ...
                        <img src=".\img/user login logo.jpeg" alt="avatar" width="32" height="32" class="rounded-circle me-2">
                    ...
                    <ul class="dropdown-menu shadow">
                        ...
                        <li><a class="dropdown-item" href="./index.html">Resume Maker</a></li>
                    </ul>
                </div>
            </dvi>
        </div>
                    ...
                    <div class="carousel-caption text-left" tyle="color: blue;">
                        ...
                        <h4 class="text-primary">Sign up today<h4>
                                ...
                                <a class="btn btn-outline-primary btn-lg mt-3" data-bs-toggle="modal"
                                    ...
                                    <a class="btn btn-outline-primary btn-lg mt-3"  href="./index.html" role="button">Create Resume</a>
                                    <!-- create from modal -->
                                <!-- userModal -->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
            <div align="center">
            <img  src=".\assets\images\curriculum-vitae.png" alt="Generic placeholder image" width="140" height="140">
    </div>
                <h2 class="text-center">You can Make your Resume/CV also...</h2>
                <p class="text-center">Craft the perfect resume with ease using our Resume Maker. <br>
                Access customizable templates, expert tips, and step-by-step instructions to build a professional resume that highlights your skills and experience,<br>
                 giving you the edge in your job search.</p>
    </div>
    </div>
    </div>
